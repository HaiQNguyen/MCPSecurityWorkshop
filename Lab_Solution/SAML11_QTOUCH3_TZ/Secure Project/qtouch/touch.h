...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(14), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(15), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(16), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(14), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(15), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(16), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_6_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(14), Y(8), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_7_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(15), Y(8), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_8_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(16), Y(8), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_9_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(14), Y(9), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_10_PARAMS                                                                                                 \
	{                                                                                                                  \
		X(15), Y(9), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
#define NODE_11_PARAMS                                                                                                 \
	{                                                                                                                  \
		X(16), Y(9), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16         \
	}
